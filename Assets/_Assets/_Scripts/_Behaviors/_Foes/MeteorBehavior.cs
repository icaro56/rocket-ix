...
public class MeteorBehavior : FoeBehavior 
{ 
	protected override void OwnUpdate ()
    {
        transform.Rotate(Vector3.up, rot.x * Time.fixedDeltaTime);
        //transform.Rotate(Vector3.right, rot.y * Time.deltaTime);

        transform.Translate(dir.x * speed * Time.fixedDeltaTime, 0, dir.y * speed * Time.fixedDeltaTime, Space.Self);
	}
	...
	protected override void OnDie()
    {
        ...
        transform.FindChild("Crista").GetComponentInChildren<ParticleSystem>().Stop();
    }
}
